...
- [betting_system](betting_system.md)
- [economy_system](economy_system.md)
# Variables
## player_hand_size
- default value: 3
- description: the number of [bet_card](bet_card.md)s the player draws at the start of each day.
## max_bet_cards_reward
- default value: 3
- description: the total number of [bet_card](bet_card.md)s the player can choose from in the bet_cards_reward_scene at the end of each day.
# Deck and hand

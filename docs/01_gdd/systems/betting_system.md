...
* [bots_simulation_system](../systems/bots_simulation_system.md)
* [bots_fighting_system](../systems/bots_fighting_system.md)
* [odds_calculation_system](../systems/odds_calculation_system.md)
* [bet_cards_system](../systems/bet_cards_system.md)
* [passive_items_system](../systems/passive_items_system.md)
# Variables
## max_bets_per_bot
* default value: 1
...
The player places bets on bots in the [betting_scene](../scenes/betting_scene.md) by [placing a bet](../mechanics/place_bet.md).
The player can place multiple bets on the same bot in the same match, limited by [max_bets_per_bot](#max_bets_per_bot).
A [placed bet](placed_bet.md)'s odds are locked to the bot's current odds — see [odds_calculation_system](../systems/odds_calculation_system.md) — at the moment the bet is placed.
# Resolving bets
When a bot match is resolved:
* If the player bet on the winning bot, they receive an amount of money equal to the bet value multiplied by the [placed_bet](../elements/placed_bet.md)'s locked odds.
...
* All of the outcomes above can be modified by [placed_bet](../elements/placed_bet.md) effects or [passive_items_system](../systems/passive_items_system.md).
# Open questions

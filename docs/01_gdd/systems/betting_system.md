...
* [economy_system](economy_system.md)
* [bots_simulation_system](bots_simulation_system.md)
* [bots_fighting_system](bots_fighting_system.md)
* [odds_calculation_system](odds_calculation_system.md)
* [bet_cards_system](bet_cards_system.md)
# Variables
## max_bets_per_bot
* default value: 1
...
The player places bets on bots in the [betting_scene](betting_scene.md) by [placing a bet](place_bet.md).
The player can place multiple bets on the same bot in the same match, limited by [max_bets_per_bot](#max_bets_per_bot).
A [placed bet](placed_bet.md)'s odds are locked to the bot's current odds — see [odds_calculation_system](odds_calculation_system.md) — at the moment the bet is placed.
# Resolving bets
When a bot match is resolved:
* If the player bet on the winning bot, they receive an amount of money equal to the bet value multiplied by the [placed bet](placed_bet.md)'s locked odds.
...
* All of the outcomes above can be modified by [placed bet](placed_bet.md) effects or [passive_item](passive_item.md).
# Open questions
